# Feedback from Pallas Selbstverteidigung
...
- [ ] Make the header more dominant, attractive, and larger overall. Spell out "ZJV" as "Zürcher Judo und Ju Jitsu Verband".
- [x] Add the logo — addressed via the splash screen (see [splash-screen.md](../splash-screen.md)) rather than the header.
...
Once some or all of these changes are in place, notify Katharina Eisenring for further feedback.
